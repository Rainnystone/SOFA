...
- **Pivot**: ≥2 轮且 Next Yield = Low → 切换到其他 mapping 方向
- **Stop**: 连续两轮无新节点或无新层级
...
- 最少 3 个 mapping 方向，每个至少 2 轮 loop；总计最少 3 轮
- 必须覆盖至少 2 种方向类型（如 vertical + alternative）
- 连续 3 轮无新节点 → 自动建议 Stop
...
- Sector Hunt: 3-5 个 mapping 方向，每个 2-3 轮 loop
